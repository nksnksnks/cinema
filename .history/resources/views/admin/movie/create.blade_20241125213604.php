                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="performer" class="control-label text-left">Performer </label>
                                    <input 
                                        type="text"
                                        name="performer"
                                        id="performer"
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="director" class="control-label text-left">Director </label>
                                    <input 
                                        type="text"
                                        name="director"
                                        id="director"
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="date" class="control-label text-left">Ngày khởi chiếu</label>
                                    <input 
                                        type="date"
                                        name="date"
                                        id="date"
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="rated_id" class="control-label text-left">Country</label>
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row mt-3" >
                                    <label for="avatar" class="control-label text-left">Ảnh đại diện <span class="text-danger">(*)</span></label>
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row mt-3" >
                                    <label for="poster" class="control-label text-left">Ảnh đại diện <span class="text-danger">(*)</span></label>
