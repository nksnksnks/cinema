...
<table class="table table-striped table-bordered" id="table-movie">
    ...
    <tr>
        ...
        <td class="text-center">
            <a href="{{ route('movieshowti.edit', $movieshow->id) }}" class="btn btn-success" ><i class="fa fa-edit"></i></a>
            <form action="{{ route('movieshow.destroy', $movieshow->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa không?')">
                @csrf
                @method('DELETE')
