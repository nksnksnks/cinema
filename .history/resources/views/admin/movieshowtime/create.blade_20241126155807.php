                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <input type="hidden" name="cinema_id" value="{{ $cinema->id }}" readonly>
                                    <input type="text"value="{{$cinema->name}}" readonly> 
                                </div>
                        </div>
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="start_time" class="control-label text-left">Cinema <span class="text-danger">(*)</span></label>
                                    <input 
                                        type="text"
                                        name="start_time"
                                        id="start_time"
