...
{{-- <script>
    const SUCCESS_CODE = {{ Constant::SUCCESS_CODE }};
    const FALSE_CODE = {{ Constant::FALSE_CODE }};
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (event) {
            ...
            .then(data => {
                if (data.status === SUCCESS_CODE) { // So sánh giá trị hằng số
