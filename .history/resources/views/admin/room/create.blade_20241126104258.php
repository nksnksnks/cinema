                ...
                <div class="ibox">
                    <div class="ibox-content">
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <input 
                                        ...
                                        name="cinema_id"
                                        id="cinema_id"
                                        value="{{ old('cinema_id', $room->cinema_id ?? '') }}"
                                        class="form-control"
                                        placeholder="Nhập ID chi nhánh"
                                        autocomplete="off"
                                    >
                                    @if($errors->has('cinema_id'))
                                        <p class="error-message">* {{ $errors->first('cinema_id') }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="country_id" class="control-label text-left">Chi nhánh (Cinema ID)  <span class="text-danger">(*)</span></label>
