                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="day_type" class="control-label text-left">Slot_name <span class="text-danger">(*)</span></label>
                                    <input 
                                        type="text"
                                        name="day_type"
                                        id="day_type"
                                        value="{{ old('day_type', $timeslot->day_type ?? '') }}"
                                        class="form-control"
                                        placeholder="..."
                                        autocomplete="off"
                                    >
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <textarea 
                                        ...
                                        stlye = "resize: none;"
                                        rows = "6"
                                    >{{ old('description', $timeslot->description ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="special_day" class="control-label text-left">timeslot <span class="text-danger">(*)</span></label>
                                    <input 
                                        type="date"
                                        name="special_day"
                                        id="special_day"
