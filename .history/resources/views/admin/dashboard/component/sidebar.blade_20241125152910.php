<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active"> 
                <a href=""><i class="fa-solid fa-globe"></i> <span class="nav-label">Quản lý phim</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li ><a href="{{route('cinema.store')}}">Thêm quốc gia</a></li>
                    <li ><a href="{{route('cinema.index')}}">Quản lý </a></li>
                    <li ><a href="{{route('cinema.store')}}">Thêm thể loại</a></li>
                    <li ><a href="{{route('cinema.index')}}">Quản lý </a></li>

                    <li ><a href="{{route('cinema.store')}}">Thêm độ tuổi</a></li>
                    <li ><a href="{{route('cinema.store')}}">Thêm phim mới</a></li>
                    <li ><a href="{{route('cinema.index')}}">Quản lý </a></li>
                </ul>
            </li>
            {{-- <li class="active">
