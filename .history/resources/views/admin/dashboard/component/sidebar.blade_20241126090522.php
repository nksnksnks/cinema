    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active"> 
                ...
                <ul class="nav nav-second-level">
                    <li ><a href="{{route('timeslot.create')}}">Thêm TimeSlot</a></li>
                    <li ><a href="{{route('timeslot.index')}}">Quản lý TimeSlot</a></li>
                </ul>
                <ul class="nav nav-second-level">
                    <li ><a href="{{route('weeklyticketprice.create')}}">Thêm weekly_ticket</a></li>
                    <li ><a href="{{route('weeklyticketprice.index')}}">Quản lý weekly_ticket</a></li>
                </ul>
            </li>
