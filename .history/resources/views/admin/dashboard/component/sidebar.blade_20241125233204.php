<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active"> 
                <a href=""><i class="fa fa-film"></i> <span class="nav-label">QL phí phụ thu</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li ><a href="{{route('specialday.create')}}">Thêm ngày đặc biệt</a></li>
                    <li ><a href="{{route('specialday.index')}}">Quản lý phim</a></li>
                </ul>
            </li>
