<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active"> 
                <a href=""><i class="fa-solid fa-globe"></i> <span class="nav-label">Quản lý thành phần</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    ...
                    <li ><a href="{{route('rated.create')}}">Thêm độ tuổi</a></li>
                    <li ><a href="{{route('rated.index')}}">Quản lý độ tuổi</a></li>                 
                </ul>
            </li>
            {{-- <li class="active">
