<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="{{ request()->routeIs('cinema.*','room.*','seattype.*') ? 'active' : '' }}">
                ...
                <ul class="nav nav-second-level">
                    <li class="{{ request()->routeIs('movieshowtime.create') ? 'active' : '' }}">
                        <a href="{{ route('movieshowtime.create') }}">Thêm loại ghế</a>
                    </li>
                    <li class="{{ request()->routeIs('movieshowtime.index') ? 'active' : '' }}">
                        <a href="{{ route('movieshowtime.index') }}">Quản lý loại ghế</a>
                    </li>
                </ul>
            </li>
