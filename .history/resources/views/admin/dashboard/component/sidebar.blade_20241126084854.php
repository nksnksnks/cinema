    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active"> 
                ...
                <ul class="nav nav-second-level">
                    <li ><a href="{{route('specialday.create')}}">Thêm TimeSlot</a></li>
                    <li ><a href="{{route('specialday.index')}}">Quản lý TimeSlot</a></li>
                </ul>
                <ul class="nav nav-second-level">
                    <li ><a href="{{route('specialday.create')}}">Thêm weekly_ticket/a></li>
