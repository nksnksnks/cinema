        ...
        switch ($method) {
            ...
            case 'PUT': // Xử lý khi cập nhật (update)
                return [
                    ...
                    'slug' => 'nullable|required|string|max:255|unique:ci_movie,slug,' . $this->route('movie'), // Unique bỏ qua slug của phim hiện tại
                    'country_id' => 'nullable|required|integer|exists:ci_country,id',
                    'rated_id' => 'nullable|required|integer|exists:ci_rated,id',
                    ...
                    'director' => 'nullable|string|max:255',
                    'description' => 'nullable|string|max:255',
                    'genre_ids' => 'nullable|required|array',
