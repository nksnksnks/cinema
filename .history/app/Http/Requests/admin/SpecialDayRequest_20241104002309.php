        ...
        switch ($method) {
            case 'POST': // Quy tắc cho việc tạo một ngày đặc biệt mới
                return [
                    ...
                    'special_day' => 'required|date|date_format:Y-m-d|unique:special_days,special_day',
            ...
            case 'PUT': // Quy tắc cho việc cập nhật một ngày đặc biệt đã tồn tại
                return [
                    'day_type' => 'required|string|max:255',
                    'description' => 'nullable|string|max:255',
                    'special_day' => 'required|date|date_format:Y-m-d|unique:ci_special_days,ci_special_day,' . $this->route('specialday')->id,
                    'extra_fee' => 'required|integer|min:0',
                ];
            default:
                return [];
