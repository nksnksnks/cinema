        ...
        try {
            ...
            $existingShowtime = MovieShowtime::where('room_id', $data['room_id'])
                ...
                ->where(function ($query) use ($data) {
                    // Kiểm tra thời gian bắt đầu và kết thúc trùng
                    $query->whereBetween('start_time', [$data['start_time'], $data['end_time']])
                          ->orWhereBetween('end_time', [$data['start_time'], $data['end_time']])
                          ->orWhere(function ($query) use ($data) {
                              // Kiểm tra thời gian bắt đầu và kết thúc hoàn toàn trùng với một showtime cũ
            ...
            if ($existingShowtime) {
                ...
                return redirect()
                    ...
                    ->with('error', trans('messages.errors.show_time.exist'));
            }
