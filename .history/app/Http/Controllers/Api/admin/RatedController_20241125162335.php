...
class RatedController extends Controller
{
    ...
    public function ratedIndex(){
        return view('admin.rated.index');
    }
    public function ratedCreate(){
        return view('admin.rated.create');
    }
    public function ratedStore(){
        return view('admin.rated.create');
    }
    public function ratedEdit(){
        return view('admin.rated.create');
    }
    public function ratedUpdate(){
        return view('admin.rated.create');
    }
    public function ratedDestroy(){
        return view('admin.rated.create');
    }
