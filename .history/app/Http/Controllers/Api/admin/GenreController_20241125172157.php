...
class GenreController extends Controller
{
    ...
    public function countryIndex(){
        $countries = Genre::all();
        return view('admin.genre.index',compact('countries'));
    }
    public function countryCreate(){
        $config['method'] = 'create';
        return view('admin.genre.create',compact('config'));
    }
    public function countryStore(GenreRequest $request)
    {
        try {
            DB::beginTransaction();
            $data = $request->all();
    ...
    public function countryEdit(string $id){
        ...
        $config['method'] = 'edit';
        return view('admin.genre.create', compact('config','country'));
    }
  
    public function countryUpdate($id, GenreRequest $request){
        try {
            DB::beginTransaction();
            $data = $request->all();
            $query = Genre::find($id);
