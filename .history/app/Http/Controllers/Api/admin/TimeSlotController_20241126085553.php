...
class TimeSlotController extends Controller
{
    ...
    public function specialdayStore(TimeSlotRequest $request)
    {
        try {
            DB::beginTransaction();
            $data = $request->all();
    ...
    public function specialdayEdit(string $id){
        $specialday = TimeSlot::find($id);
        $config['method'] = 'edit';
        return view('admin.specialday.create', compact('config','specialday'));
    }
  
    public function specialdayUpdate($id, TimeSlotRequest $request){
        try {
            DB::beginTransaction();
            $data = $request->all();
