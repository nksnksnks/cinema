...
class MovieController extends Controller
{
    ...
    public function movieStore(MovieRequest $request)
    {
        ...
        //             return redirect()
        //                 ->route('movie.create')
        //                 ->with('error', "Genre ID {$genreId} does not exist.");
        //         }
        //     }
    ...
    public function movieEdit(string $id){
        $movie = Movie::find($id);
        $config['method'] = 'edit';
        return view('admin.movie.create', compact('config','movie'));
    }
     ...
     *             @OA\Property(property="status", type="interger", @OA\Items(type="integer")),
     *             @OA\Examples(
