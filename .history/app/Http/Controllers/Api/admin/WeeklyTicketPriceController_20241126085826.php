...
class WeeklyTicketPriceController extends Controller
{
    public function specialdayIndex()
    {
        ...
        return view('admin.weekly_ticket_prices.index', compact('specialdays'));
    }
    ...
    public function specialdayStore(WeeklyTicketPriceRequest $request)
    {
        try {
            ...
            DB::commit();
            return redirect()
                ->route('weekly_ticket_prices.create')
    ...
    public function specialdayEdit(string $id)
    {
        ...
        $config['method'] = 'edit';
        return view('admin.weekly_ticket_prices.create', compact('config', 'specialday'));
    }
    ...
    public function specialdayUpdate($id, WeeklyTicketPriceRequest $request)
    {
        try {
            ...
            DB::commit();
            return redirect()
                ->route('weekly_ticket_prices.index')
                ->with('success', trans('messages.success.success'));
        } catch (\Throwable $th) {
            DB::rollBack();
            return redirect()
