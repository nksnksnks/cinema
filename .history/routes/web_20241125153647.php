...
Route::group(['middleware' => 'authenticate'], function(){
    Route::group(['middleware' => ['checkrole:1']], function () {
        ...
        //country
        Route::get('country', [CountryController::class,'countryCreate'])->name('country.index');
        Route::post('v1/admin/country/create', [CountryController::class,'countryStore'])->name('country.create');
    });
