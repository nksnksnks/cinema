...
Route::group(['middleware' => 'authenticate'], function(){
    Route::group(['middleware' => ['checkrole:1']], function () {
        ...
        Route::get('account/edit/{id}', [AccountController::class,'edit'])->name('cinema.edit');
        Route::put('v1/admin/account/update/{id}', [AccountController::class,'CinemaUpdate'])->name('cinema.update');
