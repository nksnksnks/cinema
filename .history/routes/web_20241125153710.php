...
Route::group(['middleware' => 'authenticate'], function(){
    Route::group(['middleware' => ['checkrole:1']], function () {
        ...
        //country
        Route::get('country/create', [CountryController::class,'countryCreate'])->name('country.index');
        Route::post('country/create', [CountryController::class,'countryStore'])->name('country.create');
    });
