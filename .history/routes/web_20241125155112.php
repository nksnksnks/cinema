...
Route::group(['middleware' => 'authenticate'], function(){
    Route::group(['middleware' => ['checkrole:1']], function () {
        ...
        Route::post('country/store', [CountryController::class,'countryStore'])->name('country.s');
        ...
        Route::delete('country/delete/{id}', [CountryController::class,'countryDestroy'])->name('country.delete');
        //genre
        ...
        Route::post('genre/store', [GenreController::class,'genreStore'])->name('genre.create');
        ...
        Route::delete('genre/delete/{id}', [GenreController::class,'genreDestroy'])->name('genre.delete');
        //rated
        ...
        Route::post('rated/store', [RatedController::class,'ratedStore'])->name('rated.create');
        ...
        Route::delete('rated/delete/{id}', [RatedController::class,'ratedDestroy'])->name('rated.delete');
    });
