...
Route::group(['middleware' => ['checklogin']], function () {  
    ...
    Route::post('a/a/a/register', [AuthAdminController::class, 'register'])->name('register');
...
Route::group(['middleware' => 'authenticate'], function(){
    Route::group(['middleware' => ['checkrole:1']], function () {
        ...
        Route::post('admin/cinema/create', [CinemaController::class,'create'])->name('cinema.create');
